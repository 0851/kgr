    ...
    (0, _createClass3.default)(Kgr, [{
        ...
        value: function () {
            var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(name) {
                ...
                var conf, args, url, version, source, dest, successFile, versionFile, tarName, _init, _copyDest;
        ...
        value: function gulp(name) {
            ...
            return new _promise2.default(function (resolve, reject) {
                try {
                    ...
                    stream.pipe(_gulp3.default.dest('' + dest)).on('end', _end).on('error', _error);
                } catch (e) {
                    reject(e);
                }
            });
                                        ...
                                        return _regenerator2.default.wrap(function _callee5$(_context5) {
                                            while (1) {
                                                switch (_context5.prev = _context5.next) {
                                                    case 0:
                                                        _context5.prev = 0;
                                                        _conf = _this3.configForName(name);
                                                        _context5.next = 4;
                                                        return (0, _core.findDependen)(_conf.__filename);

                                                    case 4:
                                                        files = _context5.sent;

                                                        files = files.concat((0, _core.getExistsReplace)(_conf.replace, _path2.default.dirname(_conf.__filename)));
                                                                    ...
                                                                    while (1) {
                                                                        switch (_context4.prev = _context4.next) {
                                                                            ...
                                                                            case 4:
                                                                                ...
                                                                                _dest = _this3.destPath(_conf2);

                                                                                if (_fs2.default.existsSync(_dest)) {
                                                                                    _context4.next = 8;
                                                                                    break;
                                                                                }
