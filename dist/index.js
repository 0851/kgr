	...
	(0, _createClass3.default)(Kgr, [{
		...
		value: function () {
			var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(name) {
				...
				var conf, args, _ref2, _ref3, sdtout, sdterr, url, version, source, tmp, dest, tarName, successFile, _init, _copy, _copyDest;
				...
				return _regenerator2.default.wrap(function _callee4$(_context4) {
					while (1) {
						switch (_context4.prev = _context4.next) {
							...
							case 33:
								if (_fs2.default.existsSync(_path2.default.resolve(tmp, successFile))) {
									_context4.next = 36;
									break;
								}
									...
									return _regenerator2.default.wrap(function _callee5$(_context5) {
										while (1) {
											switch (_context5.prev = _context5.next) {
												case 0:
													console.log('' + _chalk2.default.green('run add ' + (0, _stringify2.default)(addPath) + ' task...'));
									...
									return _regenerator2.default.wrap(function _callee6$(_context6) {
										while (1) {
											switch (_context6.prev = _context6.next) {
												case 0:
													console.log('' + _chalk2.default.green('run remove ' + (0, _stringify2.default)(removePath) + ' task...'));
													cmd = (0, _map3.default)(removePath, function (file) {
									...
									return _regenerator2.default.wrap(function _callee7$(_context7) {
										while (1) {
											switch (_context7.prev = _context7.next) {
												case 0:
													console.log('' + _chalk2.default.green('run replace ' + (0, _stringify2.default)(replacePath) + ' task...'));
													cmd = (0, _map3.default)(replacePath, function (file) {
														return 'cp -rf ' + file.source + ' ' + file.target;
													}).join('&&');
													_context7.next = 4;
													return (0, _core.runShell)(cmd);
